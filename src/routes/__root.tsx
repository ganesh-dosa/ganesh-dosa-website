    ...
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-accent-foreground/70">
          <span className="rounded-full bg-accent/60 px-3 py-1 text-charcoal">404</span>
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dosa Ganesh — Live Dosa Catering in Melbourne" },
      {
        ...
        content:
          "Live dosa counters, in-store parties and catering across Melbourne. Unlimited dosas, freshly made for your celebration.",
      },
