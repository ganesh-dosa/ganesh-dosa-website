...
export const Route = createFileRoute("/in-store-parties")({
  head: () => ({
    meta: [
      { title: "In-Store Dosa Parties — Dosa Ganesh Melbourne" },
      {
        name: "description",
        content: `Host your celebration at Dosa Ganesh. $${inStore.basePrice} for ${inStore.baseGuests} guests, unlimited dosas.`,
      },
    ],
  }),
